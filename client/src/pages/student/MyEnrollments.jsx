...
import {Line} from "rc-progress" //for progress bar
...
export const MyEnrollments = () => {
  ...
  const {enrolledCourses, calculateCourseDuration, navigate, getToken, backendUrl, calculateNoOfLectures, userData, fetchUserEnrolledCourses} = useContext(AppContext)
    ...
    try {
      ...
      const tempProgressArray = await Promise.all(
        enrolledCourses.map(async (course)=>{
          ...
          const lectureCompleted = data.data ? data.data.lectureCompleted.length : 0;
